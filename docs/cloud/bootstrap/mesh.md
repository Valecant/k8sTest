...
* cloned our repo
* started a Nix shell: `cd Cylcomed-IaC/nix && nix shell`
* made `Cylcomed-IaC/deployment/` your current dir.
...
We'll create 10 PVs of 1GB each. Ideally they should be backed by
...
Now get back to your Cyclomed repo on your local machine and run
...
well as the rest of the Cylcomed platform—I know, it sounds like a dog
...
all the K8s resources we declared in our repo and so slowly the Cylcomed
